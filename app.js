...
var _jhf$gangevinne$Keyboard$onCtrlDown = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (ctrl) {
			return ctrl ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (code) {
				return _elm_lang$core$Native_Utils.eq(code, 40) ? A2(_elm_lang$core$Json_Decode$field, 'ctrlKey', _elm_lang$core$Json_Decode$bool) : _elm_lang$core$Json_Decode$fail('');
			},
			_elm_lang$html$Html_Events$keyCode));
};
var _jhf$gangevinne$Keyboard$onCtrlUp = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (ctrl) {
			return ctrl ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		...
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (code) {
				return _elm_lang$core$Native_Utils.eq(code, 38) ? A2(_elm_lang$core$Json_Decode$field, 'ctrlKey', _elm_lang$core$Json_Decode$bool) : _elm_lang$core$Json_Decode$fail('');
			},
			_elm_lang$html$Html_Events$keyCode));
};
var _jhf$gangevinne$Keyboard$onShiftTab = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (shift) {
			return shift ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (code) {
				return _elm_lang$core$Native_Utils.eq(code, 9) ? A2(_elm_lang$core$Json_Decode$field, 'shiftKey', _elm_lang$core$Json_Decode$bool) : _elm_lang$core$Json_Decode$fail('');
			},
			_elm_lang$html$Html_Events$keyCode));
};
var _jhf$gangevinne$Keyboard$onTab = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (shift) {
			return shift ? _elm_lang$core$Json_Decode$fail('') : _elm_lang$core$Json_Decode$succeed(msg);
		},
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (code) {
...
var _jhf$gangevinne$Keyboard$onPageDown = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (c) {
			return _elm_lang$core$Native_Utils.eq(c, 34) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		_elm_lang$html$Html_Events$keyCode);
};
var _jhf$gangevinne$Keyboard$onPageUp = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (c) {
			return _elm_lang$core$Native_Utils.eq(c, 33) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		_elm_lang$html$Html_Events$keyCode);
};
var _jhf$gangevinne$Keyboard$onHome = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (c) {
			return _elm_lang$core$Native_Utils.eq(c, 36) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		_elm_lang$html$Html_Events$keyCode);
};
var _jhf$gangevinne$Keyboard$onEnd = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (c) {
			return _elm_lang$core$Native_Utils.eq(c, 35) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		_elm_lang$html$Html_Events$keyCode);
};
var _jhf$gangevinne$Keyboard$onUp = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (c) {
			return _elm_lang$core$Native_Utils.eq(c, 38) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		_elm_lang$html$Html_Events$keyCode);
};
var _jhf$gangevinne$Keyboard$onEsc = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (c) {
			return _elm_lang$core$Native_Utils.eq(c, 27) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		_elm_lang$html$Html_Events$keyCode);
};
var _jhf$gangevinne$Keyboard$onEnter = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (c) {
			return _elm_lang$core$Native_Utils.eq(c, 13) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		_elm_lang$html$Html_Events$keyCode);
};
var _jhf$gangevinne$Keyboard$onDown = function (msg) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (c) {
			return _elm_lang$core$Native_Utils.eq(c, 40) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail('');
		},
		_elm_lang$html$Html_Events$keyCode);
};
var _jhf$gangevinne$Keyboard$exclusiveOnKeydown = A2(
	_elm_lang$html$Html_Events$onWithOptions,
	'keydown',
	{preventDefault: true, stopPropagation: true});
var _jhf$gangevinne$Keyboard$onKeydownHtml = function (decoders) {
	return _jhf$gangevinne$Keyboard$exclusiveOnKeydown(
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (val) {
					...
					if (_p0.ctor === '::') {
						return A2(
							...
							A2(
								...
								_elm_lang$core$Json_Decode$succeed,
								A2(_elm_lang$core$Json_Decode$decodeValue, _p0._0, val)));
					} else {
						return _elm_lang$core$Json_Decode$fail('No match');
					}
				};
...
var _jhf$gangevinne$Keyboard$onKeydown = function (_p1) {
	return _mdgriffith$stylish_elephants$Element$htmlAttribute(
		_jhf$gangevinne$Keyboard$onKeydownHtml(_p1));
};
...
var _mdgriffith$stylish_elephants$Element_Keyed$column = F2(
	function (attrs, children) {
		return A5(
			_mdgriffith$stylish_elephants$Internal_Model$element,
			_mdgriffith$stylish_elephants$Internal_Model$NoStyleSheet,
			...
			_mdgriffith$stylish_elephants$Internal_Model$Keyed(
				_mdgriffith$stylish_elephants$Internal_Model$keyedColumnEdgeFillers(children)));
	});
var _mdgriffith$stylish_elephants$Element_Keyed$row = F2(
	function (attrs, children) {
		return A5(
			_mdgriffith$stylish_elephants$Internal_Model$element,
			_mdgriffith$stylish_elephants$Internal_Model$NoStyleSheet,
			...
			_mdgriffith$stylish_elephants$Internal_Model$Keyed(
				_mdgriffith$stylish_elephants$Internal_Model$keyedRowEdgeFillers(children)));
	});
var _mdgriffith$stylish_elephants$Element_Keyed$el = F2(
	function (attrs, child) {
		return A5(
			_mdgriffith$stylish_elephants$Internal_Model$element,
			_mdgriffith$stylish_elephants$Internal_Model$NoStyleSheet,
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								...
								_0: A2(
									_mdgriffith$stylish_elephants$Element$el,
									{ctor: '[]'},
									_mdgriffith$stylish_elephants$Element$text('Hei Sunniva!')),
								_1: {
									ctor: '::',
									_0: A2(
										_mdgriffith$stylish_elephants$Element$el,
													...
													_0: A2(
														...
														},
														{
															label: A2(
																...
																{ctor: '[]'},
																_mdgriffith$stylish_elephants$Element$text('Svar')),
															text: model.skrevet,
							...
							function () {
								var visRegnet = function (_p1) {
									...
									return A2(
										_mdgriffith$stylish_elephants$Element$el,
										{ctor: '[]'},
										_mdgriffith$stylish_elephants$Element$text(resultat));
								};
